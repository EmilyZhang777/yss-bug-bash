...
// import { Core } from 'js/components/Cobalt/Core.js';
// import { GoogleMaps } from '@yext/components-maps';
// import {
//   secrets__YextMapsClientGoogle,
//   secrets__YextMapsKeyGoogle,
// } from 'templates/components/Secrets/Secrets.soy';

// import { common__modules__Pin_default } from 'templates/common/modules/MapPin.soy';
...
onReady(() => {
  ...
  // mapProvider.setLoadOptions(secrets__YextMapsKeyGoogle(), {
  //   client: secrets__YextMapsClientGoogle(), // Remove this if not using Google
  // });
  // Core.init({ mapProvider, pinIcon: common__modules__Pin_default() });
});
