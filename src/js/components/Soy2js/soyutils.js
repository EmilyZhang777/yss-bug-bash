...
(function (root, goog) {
  ...
  if (!goog.i18n.bidi) {
    goog.i18n.bidi = {
      ...
      detectRtlDirectionality: function (text, opt_isHtml) {
        ...
        return (
          soyshim.$$bidiRtlWordRatio_(text) >
  ...
  /** @override */
  soydata.SanitizedHtml.prototype.contentKind =
    soydata.SanitizedContentKind.HTML;
   ...
   */
  soydata.VERY_UNSAFE.ordainSanitizedJs = soydata.$$makeSanitizedContentFactory_(
    soydata.SanitizedJs
  );
   ...
   */
  soydata.VERY_UNSAFE.ordainSanitizedUri = soydata.$$makeSanitizedContentFactory_(
   ...
   */
  soydata.VERY_UNSAFE.ordainSanitizedHtmlAttribute = soydata.$$makeSanitizedContentFactory_(
   ...
   */
  soydata.VERY_UNSAFE.ordainSanitizedCss = soydata.$$makeSanitizedContentFactory_(
   ...
   */
  soy.$$pluralIndex = function (
    value,
    locale = (window && window.Yext && window.Yext.locale) || 'en'
  ) {
  ...
  soy.$$filterNoAutoescape = function (value) {
    if (
      value &&
      value.contentKind === goog.soy.data.SanitizedContentKind.TEXT
    ) {
   ...
   * @private
   */
  soy.esc.$$REPLACER_FOR_ESCAPE_JS_STRING__AND__ESCAPE_JS_REGEX_ = function (
    ch
  ) {
  ...
  soy.esc.$$REPLACER_FOR_NORMALIZE_URI__AND__FILTER_NORMALIZE_URI_ = function (
    ...
    return soy.esc.$$ESCAPE_MAP_FOR_NORMALIZE_URI__AND__FILTER_NORMALIZE_URI_[
      ch
    ];
  };
